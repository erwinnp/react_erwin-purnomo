...
import PhotoProfile from '../assets/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg';
  ...
  return (
    <div className='home-background'>
      ...
      <div className='container h-100'>
        <div className='row-home align-items-center isi-home'>
          <div className='col-lg-4 col-md-12 col-sm-12  col-12'>
            <img id='foto-profil' src={PhotoProfile} alt='Anne Profile' />
          </div>
          <div className='col-lg-8 col-md-12 col-sm-12 col-12'>
